...
loadfromfile = 0;
params = read_from_json('test1framePerSecFor20Seconds.mmwave.json');

% Adjust numFrames to cover 20 seconds
framePeriodicity = params.framePeriodicity; % Assuming this is defined in the JSON configuration
numFrames = 20 / framePeriodicity; % Calculate the number of frames for 60 seconds
...
magnitudesOverTime = zeros(numFrames,30000,1);
